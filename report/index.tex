...
geschaltet. Ein erster Versuch ist der Abbildung~\ref{fig-wienvarak} zu
entnehemen.
...
\includegraphics[width=0.8\linewidth,height=\textheight,keepaspectratio]{./images/Ich_habe_nixi_Bildi.png}

}

\caption{\label{fig-wienvarak}Wien-Robinson-Oszillator mit Frequenzhub}
